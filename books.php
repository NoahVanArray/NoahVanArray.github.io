		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				<section id="header" class="wrapper">
					...
					<!-- Logo -->
						<div id="logo">
							<h1><span><a href="index.html">Yverdon Book Management System</a></span></h1>
									...
									<div id="sidebar">
										<section class="box">
											...
											<ul class="style2">
												...
												<li>
													<article class="box post-excerpt">
														<a href="#" class="image left"><img src="images/edu.png" alt="" /></a>
												...
												<li>
													<article class="box post-excerpt">
														<a href="#" class="image left"><img src="images/fic.png" alt="" /></a>
												...
												<li>
													<article class="box post-excerpt">
														<a href="#" class="image left"><img src="images/literature.png" alt="" /></a>
												...
												<li>
													<article class="box post-excerpt">
														<a href="#" class="image left"><img src="images/entert.png" alt="" /></a>
												...
												<li>
													<article class="box post-excerpt">
														<a href="#" class="image left"><img src="images/philo.png" alt="" /></a>
			...
			<!-- Footer -->
				<section id="footer" class="wrapper">
					...
					<div class="container">
						...
						<div id="copyright">
							<ul>
								<li>&copy; Das Kumarades LLC. EST. 2023. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
							</ul>
						</div>
					</div>
				</section>
